...
models = {
    pybamm.current_collector.EffectiveResistance(options1, name = "Current collector"), 
    pybamm.lithium_ion.SPM(options1, name="SPM"),
}
...
for model in models:
    ...
    # solve model 
    if model.name == "Current collector":
        ...
        # solution = sim.solve(solver=pybamm.CasadiAlgebraicSolver(), t_eval=t_eval)
