...
class BaseModel(pybamm.BaseBatteryModel):
    ...
    **Extends:** :class:`pybamm.BaseBatteryModel`
    ...
    def __init__(self, options=None, name="Unnamed alkaline model"):
        super().__init__(options, name)
        self.param = pybamm.standard_parameters_alkaline # check these parameters

    @property
    def default_parameter_values(self):
        return pybamm.ParameterValues(chemistry=pybamm.parameter_sets.Lu2019)
    ...
    def set_standard_output_variables(self):
        ...
        # Time
        time_scale = pybamm.standard_parameters_alkaline.tau_discharge
