...
h_an = pybamm.Parameter("Enthalpy of anode decomposition [J.kg-1]")
h_ca = pybamm.Parameter("Enthalpy of cathode decomposition [J.kg-1]")
h_sei = pybamm.Parameter("Enthalpy of SEI decomposition [J.kg-1]")
