...
clc; tic;
p = py.sys.path;
p.insert(int32(1),'C:\Users\Vivian\Dropbox (University of Michigan)\from_box\Research\PyBaMM\PyBaMM') %path to pybamm package
p.insert(int32(2),'C:\Users\Vivian\Dropbox (University of Michigan)\from_box\Research\PyBaMM\PyBaMM\venv\Lib\site-packages') % path to other libraries in venv
pybamm = py.importlib.import_module('pybamm');

% % Regenerate the casadi objects
py.pybamm_setup_example.main()
...
% Run the simulation
% cd('C:\Users\Vivian\University of Michigan Dropbox\Vivian Tran\from_box\Research\PyBaMM\PyBaMM\pybamm_simulink')
N_sum = 1;
