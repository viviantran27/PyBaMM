classdef pybamm_bat < matlab.System %& matlab.system.mixin.Propagates
    ...
    methods(Access = protected)
        ...
        function [dt1, dt2, dt3, dt4, dt5, dt6, dt7, dt8, dt9, dt10, dt11] = getOutputDataTypeImpl(~)
        	dt1 = 'double';
            dt2 = 'double';
            dt3 = 'double';
            dt4 = 'double';
...
%             dt3 = 'double';
        ...
        function [sz1, sz2, sz3, sz4, sz5, sz6, sz7, sz8, sz9,sz10, sz11] = getOutputSizeImpl(~)
        	sz1 = 1;
            sz2 = 1;
            sz3 = 1;
            sz4 = 60;
...
%             cp3 = false;
        ...
        function [cp1, cp2, cp3, cp4, cp5, cp6, cp7, cp8, cp9, cp10, cp11] = isOutputComplexImpl(~)
        	cp1 = false;
            cp2 = false;
            cp3 = false;
            cp4 = false;
...
%             fz3 = true;
        ...
        function [fz1, fz2, fz3, fz4, fz5, fz6, fz7, fz8, fz9, fz10, fz11] = isOutputFixedSizeImpl(~)
        	fz1 = true;
            fz2 = true;
            fz3 = true;
            fz4 = true;
        ...
        %%
        function [V_t, ocv, T, ce, heating, neg_conc, pos_conc, x_sei, V_meas, ocp_n, ocp_p] = stepImpl(obj, current)
...
%             inputs = [T_non_dim, current];
            ...
            x_sei = temp(105);
            V_meas = temp(106);
            ocp_n = temp(107:(107+20-1));
            ocp_p = temp(127:(127+20-1));
